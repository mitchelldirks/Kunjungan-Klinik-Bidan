        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="tempatlahir" value="<?php echo $edit['tempatlahir'] ?>">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label class="bmd-label-floating">Tanggal Lahir</label>
              <input type="date" class="form-control" max="<?php echo date('Y-m-d'); ?>" name="tanggallahir" value="<?php echo $edit['tanggallahir'] ?>">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label class="bmd-label-floating">Telpon</label>
              <input type="tel" class="form-control" name="tel" value="<?php echo $edit['tel'] ?>">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="spesialisasi" value="<?php echo $edit['spesialisasi'] ?>">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="alamat" rows="5"><?php echo $edit['alamat'] ?></textarea>
              </div>
            </div>
          </div>
        </div>
